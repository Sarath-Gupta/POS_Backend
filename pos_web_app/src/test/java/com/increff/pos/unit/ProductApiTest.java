...
public class ProductApiTest {
    ...
    public void findByBarcode_existingBarcode_shouldReturnProduct() {
    ...
    @Test
    @DisplayName("findByBarcode() should return null when barcode does not exist")
    public void findByBarcode_nonExistentBarcode_shouldReturnNull() {
